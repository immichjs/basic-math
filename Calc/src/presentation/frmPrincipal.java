...
public class frmPrincipal extends javax.swing.JDialog
{
    ...
    private void send(String operation) {
        Controle controle = new Controle(txfPrimeiroNumero.getText(), txfSegundoNumero.getText(), operation);
        
        if (controle.getMessage().equals("")) {
            lblResultado.setText(controle.getResult());
        } else {
            JOptionPane.showMessageDialog(null, controle.getResult());
        }
    }
